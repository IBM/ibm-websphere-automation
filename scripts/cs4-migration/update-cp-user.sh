...
# Follow https://www.ibm.com/docs/en/cloud-paks/foundational-services/4.9?topic=configurations-changing-cluster-administrator-access-credentials
...
# Follow https://www.ibm.com/docs/en/cloud-paks/foundational-services/4.9?topic=login-cannot-log-in-console-after-reinstallation-foundational-services
